...
$(function(){
    ...
    var troveAPIKey = 'aqs1r1d5eggh68t7';
    ...
    var titles = '1187';
    // Add a byline, eg:
    var byline = 'Tharunka element added by <a href="https://www.recordkeeping.unsw.edu.au">UNSW Archives</a> using the game designed by <a href="https://timsherratt.org">Tim Sherratt</a>.'
    // var byline = '';
    // Add a tagline
    ...
    function clean_query() {
        var query;
        if (useHttps === 'false') {
            query = 'https://api.trove.nla.gov.au/v2/result?q=zone=newspaper&l-category=Article&encoding=json&key=aqs1r1d5eggh68t7'
        } else {
